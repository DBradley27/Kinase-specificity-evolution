---
title: "Kinase_divergence_example"
...
```{r,echo=FALSE,out.width = "200px",include=TRUE}
knitr::include_graphics("example_kinase_crop.png", auto_pdf=FALSE)
```
