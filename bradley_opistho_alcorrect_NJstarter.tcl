seqfile = ../opistho_linsi_alcorrect_trim80_filter190_mod.fa   * sequence data filename
treefile = ../RAxML_bestTree_midpoint.alcorrect_linsi190_NJ  * tree structure file name
outfile = bif_opistho.mlc    * main result file name
...
aaRatefile = lg_LG.PAML.txt  * only used for aa seqs with model=empirical(_F)
